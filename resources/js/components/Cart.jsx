        ...
        handleClickSubmit() {
            if (this.state.sales_type == "grocery") {
                ...
                Swal.fire({
                    ...
                    input: "number",
                    inputAttributes: {
                        min:this.getTotal(this.state.cart).toString(),
                        id: 'myInput',
                        step:500
                    },
                    inputValue: this.getTotal(this.state.cart).toString(),
                    showCancelButton: true,
                    confirmButtonText: "Kirim",
                    cancelButtonText: "Batal",
                    showLoaderOnConfirm: true,
                    inputValidator: (amount) => {
                        console.log(amount, this.getTotal(this.state.cart).toString());
                        if (parseInt(amount) < parseInt(this.getTotal(this.state.cart).toString())) {
